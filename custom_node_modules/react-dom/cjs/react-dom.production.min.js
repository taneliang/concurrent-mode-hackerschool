...
function kd(a,b,c,d){if(id){var e=0===(b&4);if(e&&0<lc.length&&-1<sc.indexOf(a))uc(null,a,b,c,d);else{var f=Cc(a,b,c,d);if(null===f)e&&wc(a,d);else{if(e){if(-1<sc.indexOf(a)){uc(f,a,b,c,d);return}if(yc(f,a,b,c,d))return;wc(a,d)}md(a,b,d,null,c)}}}}
...
exports.unstable_scheduleHydration=function(a){if(a){var b=u.unstable_getCurrentPriorityLevel(),c=ic();a={blockedOn:null,target:a,priority:b,lanePriority:c};for(c=0;c<rc.length&&!(b<=rc[c].priority);c++);rc.splice(c,0,a);0===c&&zc(a)}};exports.version="17.0.0-alpha.0";
